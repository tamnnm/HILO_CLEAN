...
# Quick way to create netcdf
# Create a sample Dataset
data = np.random.rand(5, 5)
coords = {'lat': np.linspace(0, 4, 5), 'lon': np.linspace(0, 4, 5)}
dts = xr.Dataset({'data': (['lat', 'lon'], data)}, coords=coords)

# Create a sample boolean array
boolean_array = np.array([[True, True, True, False, False],
                          [True, True, True, False, False],
                          [True, True, True, False, False],
                          [True, True, True, False, False],
                          [True, True, True, False, False]])

# Add the boolean array to the Dataset as a new variable 'mask'
dts['mask'] = (['lat', 'lon'], boolean_array)
