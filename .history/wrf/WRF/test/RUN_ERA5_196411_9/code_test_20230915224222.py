...
import itertools
from wrf import *
from xtci.shared.entropy_deficit import entropy_deficit as ent_def
from xtci.shared.potential_intensity_tcpypi import potential_intensity as pi
from xtci.shared.wind_shear import wind_shear as w_shear
from xtci.shared.absolute_vorticity import absolute_vorticity as abs_vor
...
dataset = xr.open_dataarray(filename)
# Variable
slp = getvar(dataset, "slp", units="hPa")
p = getvar(dataset, "z", units="hPa")
