...
start = datetime.datetime.strptime(f'{"01-01-"+year_start}', "%d-%m-%Y")
end = datetime.datetime.strptime(f'{"31-03-"+year_end}', "%d-%m-%Y")
date_generated = [
...
time_period = np.arange(year_start, year_end)
