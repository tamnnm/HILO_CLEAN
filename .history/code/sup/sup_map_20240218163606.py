...
for i in range(4,2,-1):
    if number_file%i == 0:
        ...
        continue
fig,axs = plt.subplots(no_hor,no_ver,subplot_kw=dict(projection=ccrs.PlateCarree()),sharex=False, sharey=True, gridspec_kw={'hspace': 0, 'wspace': 0})
...
#"""
    ...
    ins = ax.inset_axes([0.75,0.7,0.3,0.2])
