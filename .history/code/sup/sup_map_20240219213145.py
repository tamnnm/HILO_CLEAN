...
for i in range(4,2,-1):
    if number_file%i == 0:
        ...
        continue
fig,axs = plt.subplots(no_hor,no_ver,subplot_kw=dict(projection=ccrs.PlateCarree()),sharex=True, sharey=True, gridspec_kw={'left':.1, 'bottom':.05, 'right':.12, 'top':.1,'hspace': 0.08, 'wspace': 0})
