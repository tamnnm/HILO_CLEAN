...
noaa = xr.open_dataset(
    "/data/projects/REMOSAT/tamnnm/wrf_data/netcdf/noaa_daily/indices_full/noaa_228_2004.nc")['apcp'].sel(lat=21.0, lon=107.0)
# link+"/noaa_228.nc")['apcp'].sel(lat=21.0, lon=107.0)
