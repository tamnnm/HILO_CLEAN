...
link_2 = "/data/projects/REMOSAT/tamnnm/wrf_data/netcdf/noaa/noaa_synop_1877_2015/indice_full"
link_3 = "/data/projects/REMOSAT/tamnnm/wrf_data/netcdf/noaa/noaa_synop_1877_2015/full_nc"
fig, ax = plt.subplots()

# cera = xr.open_dataset(link+"/cera_228.nc")['tp'].sel(lat=21.0, lon=105.0)
...
noaa = xr.open_dataset(
    link_2+"/noaa_228_1973.nc")['apcp'].sel(lat=21.0, lon=105.0) * 8
noaa_2 = xr.open_dataset(
    link_3+"/noaa_228_1990.nc")['apcp'].sel(lat=21.0, lon=105.0) * 10
noaa_3 = xr.open_dataset(
    link+"/noaa_228.nc")['apcp'].sel(lat=21.0, lon=105.0) / 10
...
print(noaa['time'])
print(noaa_2['time'])
# cera.plot(ax=ax, label='cera')
# era.plot(ax=ax, label='era')
# era_5.plot(ax=ax, label='era_5')
noaa_3.plot(ax=ax, label='noaa_main', alpha=0.5)
noaa_2.plot(ax=ax, label='noaa_2')
noaa.plot(ax=ax, label='noaa')
