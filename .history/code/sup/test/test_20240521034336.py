...
link_2 = "/data/projects/REMOSAT/tamnnm/wrf_data/netcdf/noaa/noaa_synop_1877_2015/full_nc"
fig, ax = plt.subplots()
...
noaa = xr.open_dataset(link_2+"/noaa_228_1990.nc")['apcp'].sel(lat=21.0, lon=105.0) *2
