...
cera = xr.open_dataset(link+"/cera_228.nc").mean(dim=['lat'm'])
era = xr.open_dataset(link+"/era_228.nc")
era_5 = xr.open_dataset(link+"/era5_228.nc")
noaa = xr.open_dataset(link+"/noaa_228.nc")
obs = xr.open_dataset(link+"/obs_228.nc")
