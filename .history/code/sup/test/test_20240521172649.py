...
cera = xr.open_dataset(
    link+"/mean_cera_167.nc")['t2m'].sel(lat=21.0, lon=106.0)
era = xr.open_dataset(link+"/mean_era_228.nc")['var228'].sel(lat=21.0, lon=106.0)
era_5 = xr.open_dataset(
    link+"/mean_era5_167")['var167'].sel(lat=21.25, lon=106.25)
noaa = xr.open_dataset(
    link+"/mean_noaa_167.nc")['apcp'].sel(lat=21.0, lon=107.0) * 2
