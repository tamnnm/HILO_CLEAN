...
cera = xr.open_dataset(link+"/cera_228.nc").slice(lat=slice(40, -15), lon=slice(80, 150))
era = xr.open_dataset(link+"/era_228.nc").mean(dim=['lat','lon'])
era_5 = xr.open_dataset(link+"/era5_228.nc").mean(dim=['lat','lon'])
