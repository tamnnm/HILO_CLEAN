...
era = xr.open_dataset(link+"/era_228.nc")['var228'].sel(lat=21.0, lon=106.0)
era_5 = xr.open_dataset(
    link+"/mean_cera_167")['var228'].sel(lat=21.25, lon=106.25)
noaa = xr.open_dataset(
    link+"/mean_cera_167.nc")['apcp'].sel(lat=21.0, lon=107.0) * 2
obs = xr.open_dataset(link+"/mean_cera_167.nc")['R'].sel(no_station=61)
