...
#"""
    ...
    ax.grid(linewidth=1, color='gray', alpha=0.5,
                    linestyle='--')
    ax.text(110,23,var_name.split("_")[0],color='black',fontsize=15)
    ax.text(115,10,"Stating year",fontsize=7)
#"""
...
fig.suptitle("Station distribution in Vietnam",fontsize=20, y=0.98)
fig.tight_layout()
