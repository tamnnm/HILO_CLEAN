...
for i in range(4,2,-1):
    if number_file%i == 0:
        ...
        continue
fig,axs = plt.subplots(no_hor,no_ver,subplot_kw=dict(projection=ccrs.PlateCarree()),sharex=True, sharey=True, gridspec_kw={eft=.1, bottom'=.05, 'right'=.99, 'top':.8,'hspace': 0.08, 'wspace': 0})
