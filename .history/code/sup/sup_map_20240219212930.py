...
for i in range(4,2,-1):
    if number_file%i == 0:
        ...
        continue
fig,axs = plt.subplots(no_hor,no_ver,subplot_kw=dict(projection=ccrs.PlateCarree()),sharex=True, sharey=True, gridspec_kw={eft=.1, bottom=.05, right=.99, top=.8, wspace=.1, hspace=.3'hspace': 0.08, 'wspace': 0})
...
#"""
    ...
    ax.text(114,25,"Stating year",fontsize=7)
#"""
...
fig.suptitle("Station distribution in Vietnam",fontsize=20, y=0.97)
#fig.tight_layout()
