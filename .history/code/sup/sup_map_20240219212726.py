...
params = {
	...
	'figure.figsize': [8, 10], # instead of 4.5, 4.5
	'axes.linewidth': 1.5,
...
for i in range(4,2,-1):
    if number_file%i == 0:
        ...
        continue
fig,axs = plt.subplots(no_hor,no_ver,subplot_kw=dict(projection=ccrs.PlateCarree()),sharex=True, sharey=True, gridspec_kw={'hspace': 0.08, 'wspace': 0.08})
