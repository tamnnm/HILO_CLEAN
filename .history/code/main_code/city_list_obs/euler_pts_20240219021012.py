...
Data_name = {'era':'era_daily/subset/','era5':'era5_daily/full_nc',
             'cera':'cera_daily/subset/','noaa_daily/full_nc']
...
for file_path in Data_name:
    ...
    with xr.open_dataset(f'{Data_path+file_path+"era5_167.nc"}') as ds:
