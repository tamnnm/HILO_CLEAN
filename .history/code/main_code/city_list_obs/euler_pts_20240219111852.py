...
Code_wd = "/work/users/tamnnm/code/maincity_list_obs/"
...
for file_path in Data_name.keys():
    ...
    # MUST: add values or else it appears as a dataarray subset
        ...
        for city_list in glob.glob("/work/users/tamnnm/code/main_code/city_list_obs/city/*.txt"):
            with open(Code_wd+, 'r') as f:
                lines = f.readlines()
                f.close()
