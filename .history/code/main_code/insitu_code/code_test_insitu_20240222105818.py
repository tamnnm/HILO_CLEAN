...
def gen_base(dataset:Optional[Literal["cera","era","era5","noaa","obs"]],var:Optional[Liter'uwnd','vwnd','tp','min','max'],start:Optional[int],end:Optional[int],percentile:list = None,window='5'):
    #create base file
    var_no=param[var]
    fol=f'para_{var_no}/'
...
def get_name_files(dataset: Optional[Literal["cera","era","era5","noaa", "obs"]],var=None,ind=None,,type_ind: Optional[Literal['min','max']] =None, base: bool=False, percentile: Optional[str] = None, window: Optional[int] = 5):
