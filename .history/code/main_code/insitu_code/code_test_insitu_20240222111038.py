...
def get_name_files(dataset,var=None,ind=None, base: bool=False, percentile: Optional[str] = None, window: Optional[int] = 5):
    if ind is not None:
    ...
    ibminfile,ibmaxfile=get_name(fol,dataset,type_ind='min',base,rp)[0],get_name(fol,dataset,type_ind='max', base,rp)[0]
