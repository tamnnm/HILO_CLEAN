...
# ------------------------ reanlysis indices ----------------------- #
def gen_base(ofile,y_start,y_end,dataset,var):
    #create base file for wet days
    ifile="Data_nc/{dataset}_{var}.nc"
    ofile="Data_nc/{dataset}_{var}_base.nc"
    if os.path.exist()
    cdo.setrtomiss('0','0.999',input=f"Data_nc/{dataset}_{var}.nc",output=f"Data_nc/{dataset}_{var}_base.nc")
