...
def gen_base(dataset:Optional[Literal["cera","era","era5","noaa","obs"]]var:Optional[list(param.keys())],start:Optional[int],end:Optional[int],percentile:list = None,window='5'):
    #create base file
    var_no=param[var]
    fol=f'para_{var_no}/'
