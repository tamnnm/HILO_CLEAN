...
def get_name_files(var=None,ind=None, dataset: Optional[Literal["cera","era","era5","noaa", "obs"]],type_ind: Optional[Literal['min','max']] =None, base: bool=False, percentile: Optional[str] = None, window: Optional[int] = 5):
