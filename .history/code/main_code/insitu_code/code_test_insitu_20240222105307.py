...
def get_name_files(ind, dataset: Optional[Literal["cera","era","era5","noaa", "obs"]],type_ind: Optional[LiteralNone, base: bool=False, percentile: Optional[str] = None, window: Optional[int] = 5):
