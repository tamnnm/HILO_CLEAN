...
param = {'uwnd': {'var_no':'165', 'type':'non_extreme'},
         'vwnd': {'var_no':'165', 'type':'non_extreme'},
         'min': {'var_no':'165', 'type':'non_extreme'},
         'max': {'var_no':'165', 'type':'non_extreme'},
         't2m':{'var_no':'165', 'type':'non_extreme'}, #Not exist yet but will be
         'tp': {'var_no':'165', 'type':'non_extreme'},
         }
#endregion
