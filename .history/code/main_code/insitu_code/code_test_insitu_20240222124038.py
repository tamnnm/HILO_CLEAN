...
def get_name_files(dataset,var=None,ind=None, base: bool=False, rp: Optional[str] = None, window: Optional[int] = 5):
    ...
    fol = f'para_{var_no}/'
    def get_name(fol=fol,dataset=dataset,var_no=var_no,type_ind=None, base: bool=False, rp: Optional[str] = None):
    ...
    if var_no=='167':
        iminfile,ibmaxfile=get_name(type_ind="min")[0],get_name(type_ind="max")[0]
