...
def gen_base(var:Optional[Literal["cera","era","vwnd","uwnd"]],start:Optional[int],end:Optional[int],dataset:Optional[Literal["cera","era","era5","noaa"]],percentile:list = None,window='5'):
    #create base file
    var_no=param[var]
    fol=f'para_{var_no}/'
