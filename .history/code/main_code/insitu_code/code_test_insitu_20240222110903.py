...
def get_name_files(dataset,var=None,ind=None, base: bool=False, percentile: Optional[str] = None, window: Optional[int] = 5):
    ...
    iminfile,imaxfile=get_name(fol,dataset,type_ind='min')[0],imaxfile=get_name(fol,dataset,type_ind='max')[0]
    ibminfile,ibmaxfile=get_name(fol,dataset,type_ind='min')[0],ibmaxfile=get_name(fol,dataset,type_ind='max')[0]
