...
class gen_ind:
    ...
    def gen_tp(self):
        if not check_exist(self.ofile): cdo.timpctl('10',input=f'{self.ifile} -timin {self.ibfile} -timax {self.ibfile}',output=self.ofile)
