...
# -------------------------- Caculate gpi -------------------------- #
    ...
    dname = 'chi'
    ofile = os.path.join(Data_path, ibasename.replace('.nc', f'.{dname}.nc') )
    ...
    dname = 'chi_sb'
    ofile = os.path.join(Data_result, ibasename.replace('.nc', f'.{dname}.nc') )
    if os.path.exists(ofile):
    ...
    ofile = os.path.join(Data_result, ibasename.replace('.nc', f'.PI.nc') )
    if os.path.exists(ofile):
