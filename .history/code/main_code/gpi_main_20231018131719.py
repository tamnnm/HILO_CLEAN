...
from pkg_twcr import constant as cs
import xarray as xr
import numpy as np
import os

from gpi_main import pi, wind_shear as ws, abs_vor as av, cut_one as co
...
if __name__ == '__main__':
    ...
    lat_ocean,lon_ocean=co.cut_co(fn_ocean,ulat=5,dlat=25,ulon=118,dlon=100)
    ...
    do_tci(sst=sst_org,prmsl=prmsl_org,prs=level_data,T=T,rhum=rhum,uwnd=uwnd,vwnd=vwnd,lon_ocean=lon_ocean,lat_ocean=lat_ocean)
