    ...
    def gen_diso_df(dataset):
        ...
        for ind in list_ind:
            ...
            # Example at this step: result_df = [{'R': 1,'DISO':2},{'R': 3,'DISO':4},{'R': 5,'DISO':6]
                result_dict =  {key: [d.get(key, None) for d in result_sub_com] # Get the value of the key and put in list
                          for key in set().union(*result_sub_com)} # Get the set of all the keys
