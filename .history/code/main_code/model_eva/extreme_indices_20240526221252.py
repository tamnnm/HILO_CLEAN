...
def get_ifiles(ind, dataset):
    ...
    If the number is 167, it checks which category the index falls into ('other', 'min', or 'max')
    and returns the appropriate file paths.
    If the number is not 167, it returns the folder path and the path for the dataset file,
...
class gen_ind:
    ...
    def __call__(self, ind, dataset):
        ...
        print(self.ind, iminfile, imaxfile)
