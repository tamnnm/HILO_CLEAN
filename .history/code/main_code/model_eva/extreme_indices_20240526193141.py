    ...
    def gen_diso_df(dataset):
        ...
        for ind in list_ind:
            ...
            for i, no_city in enumerate(list_no_city):
                ...
                if i == 0:
                    main_dict = [sub_dict]
                    main_ob_dict=[obs_sub_dict]
                else:
                    main_dict.append(sub_dict)
                    main_ob_dict.append(obs_sub_dict)
            try:
                ...
                result_obs_dict={key: [d.get(key, None) for d in main_dict]  # Get the value of the key and put in list
                               for key in set().union(*main_obsdict)}
