...
Data_csv = Data_wd+"wrf_data/netcdf/para"
...
def merge_diso_df(var):
    ...
    def gen_diso_df(dataset):
        ...
        ind_ind = f'{Data_ind}csv_file/{dataset}_{var}_indices.csv'
        ...
        for ind in list_ind:
            ...
            #              'geo']), sub_obs.where(sub_obs['no_station'] == no_city, drop=True), check=True) for i, no_city in enumerate(list_no_city)]
