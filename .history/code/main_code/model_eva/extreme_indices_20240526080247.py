    ...
    def gen_diso_df(dataset):
        ...
        for ind in list_ind:
            ...
            for i, no_city in enumerate(list_no_city):
                ...
                if i==0:
                    result_sub_com=[evaluate_all(obs_data, rean_data,metrics_compare)]
                    result_sub_sing=[evaluate_single_all(rean_data)]
                else:
                    result_sub_com.append(evaluate_all(obs_data, rean_data,metrics_compare))
                    result_sub_sing.append(evaluate_single_all(rean_data)]
            try:
