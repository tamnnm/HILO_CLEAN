...
def cluster_plot(resample_mode = 3):
    ...
    matplotlib.rcParams.update(params)
    data = pd.read_csv(f"gev_Tn/OG_{resample_mode}_test.csv")
    ...
    fig.tight_layout()
    fig.savefig(os.getenv('img')+f"/SOM_cluster_map_Tn_{resample_mode}.png", bbox_inches='tight', transparent=True)
#"""
#endregion
