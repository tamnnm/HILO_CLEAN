...
if __name__ == '__main__':
    print(os.getenv("wrf_data"))
    Data_path = os.path.join(os.getenv("wrf_data")+"netcdf/noaa_daily")
    os.chdir(Data_path)
    demo_sh = open_nc_file("shum.1881.nc")
    demo_u = open_nc_file("uwnd.1881.nc")
    demo_v = open_nc_file("vwnd.1881.nc")
    demo_sP = open_nc_file("pres.sfc.1881.nc")
