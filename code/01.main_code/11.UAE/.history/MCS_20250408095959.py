...
from my_junk import gradient_ds, find_name, open_
# endregion
...
if __name__ == '__main__':
    Data_path = os.join.path(os.getenv("wrf_data"), "/netcdf/noaa_daily/")
    os.chdir(Data_path)
    demo_sh = open_nc_file("shum.1881.nc")['shum']
    demo_u = xr.open_dataset("uwnd.1881.nc")['uwnd']
    demo_v = "vwnd.1881.nc"
    demo_sP = "pres.sfc.1881.nc"
