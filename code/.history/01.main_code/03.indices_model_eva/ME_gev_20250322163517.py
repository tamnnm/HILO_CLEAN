...
shp_path = gpd.read_file(os.getenv("vnm_sp"))
# vnamp = gpd.read_file(shp_path)
vnmap = shp_file.geometry
...
def cluster_plot(resample_mode = 3):
    ...
    mask = Polygon(rec_bound(geo_limit).difference(vnmap))
