...
def point_map(par:Optional[Literal['R','T2m']] = 'R',dataset:Optional[Literal['rean', 'obs']]= 'rean', direction = 'verticle'):
    ...
    legend = ax.legend()
    fig.tight_layout()
    fig.savefig(f'/work/users/tamnnm/code/02.sup/image/{par}_MK_{dataset}_{direction}_legend.jpg',
