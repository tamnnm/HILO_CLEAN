...
pcp_ds = xr.decode_cf(xr.open_dataset(os.path.join(Ind_wd, "seas_PRCPTOT_obs_v2.nc")))['R']
no_wet_ds = xr.decode_cf(xr.open_dataset(os.path.join(Ind_wd, "seas_no_wet_obs_v2.nc")))['R']
sdii_ds = xr.decode_cf(xr.open_dataset(os.path.join(Ind_wd, "seas_SDII_obs_v2.nc")))['R']
...
def plot_dom():
    ...
    for i,ax in enumerate(axes.flatten()):
        ...
        ax.pie([base.count(0), base.count(1)],# labels = ['Frequency', 'Intensity'],
               autopct='%1.1f%%', colors = ['#bd004e', '#142354'], startangle=90,
               radius=0.9,pctdistance = 0.81,textprops = {'color': 'w','rotation' : 30, 'fontsize': 35},
