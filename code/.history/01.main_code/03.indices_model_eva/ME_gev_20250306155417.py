...
def cluster_plot(resample_mode = 3):
    ...
    ax2.scatter(data['shape'], data['loc'], c=data['cluster'], cmap=cluster_cmap, s=600, alpha = 0.5)
    ax2.set_xlabel(r'$\mathrm{k}$')
    ax2.set_ylabel(r'$\mu$')

    ax3.scatter(data['loc'], data['scale'], c=data['cluster'], cmap=cluster_cmap, s=600, alpha = 0.5)
    ax3.set_xlabel(r'$\mu$')
    ax3.set_ylabel(r'$\sigma$')
    ax4.scatter(data['scale'], data['shape'], c=data['cluster'], cmap=cluster_cmap, s=600, alpha=0.5)
