...
def plot_dom():
    ...
    for i,ax in enumerate(axes.flatten()):
        ...
        for autotext in p:
            ...
            if i!=2:
                autotext.set_rotation(10) if pct < 30 and pct > 15 else otext.set_rotation(-7)
                
        w,l,p=ax.pie([now.count(0), now.count(1)],# labels = ['Frequency', 'Intensity'],
            autopct='%1.1f%%',pctdistance = 0.78, colors = ['#bd004e', '#142354'], startangle=angle,
