...
for j,ax in enumerate(axes.flatten()):
    for i in range(12):
        ...
        # else:
            ...
            data = pd.concat([org_data['name_station'], org_data['scale'], org_data['shape'], org_data['DT_20'], org_data['DT_50'], org_data['DT_MST']], axis=1)
        ...
        if i_ri%3 == 0: # or i_ri == 1:#(i_ri == 1 and j%2 != 0):
            ...
            if 'MST' in indice_list[int(j//2)]:
                ...
                max_value = max_20 if '20' in indice_list[int(j//2)] else max_50
                sc = ax.scatter(valid_data['shape'], max_value - valid_data[indice_list[int(j//2)]], c=valid_data['scale'], marker=markers[order], cmap='Spectral', s=100, edgecolors=edgecolors[order])
