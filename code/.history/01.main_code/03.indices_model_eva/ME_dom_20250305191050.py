...
def plot_dom():
    ...
    for i,ax in enumerate(axes.flatten()):
        ...
        ax.pie([base.count(0), base.count(1)],# labels = ['Frequency', 'Intensity'],
               autopct='%1.1f%%', colors = ['#bd004e', '#142354'], startangle=90,
               radius=0.9,pctdistance = 0.81,textprops = {'color': 'w','rotation' : 30, 'fontsize': 30},
        ...
        ax.pie([now.count(0), now.count(1)],# labels = ['Frequency', 'Intensity'],
               ...
               radius=0.6,textprops = {'color': 'w','rotation' : 30, 'fontsize': 30},
               wedgeprops=dict(width=0.4,edgecolor = 'w', linewidth = 10))
        ax.text(0.1, 0.9, seas[i], fontsize = 45, weight = 'bold', ha = 'center', va = 'center', transform = ax.transAxes)
