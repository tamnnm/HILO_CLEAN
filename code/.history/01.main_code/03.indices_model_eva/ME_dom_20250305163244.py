...
def plot_dom():
    ...
    for i,ax in enumerate(axes.flatten()):
        ...
        ax.pie([base.count(0), base.count.count(1)], labels = ['Frequency', 'Intensity'], autopct='%1.1f%%', colors = ['#bd004e', '#142354'], startangle=90)
        ax.pie([now.count(0), now.count.count(1)], labels = ['Frequency', 'Intensity'], autopct='%1.1f%%', colors = ['#bd004e', '#142354'], startangle=90)



# fig.tight_layout()
# fig.savefig(os.path.join(img_wd, "ME_dom.png"), bbox_inches = 'tight', dpi = 300)
#endregion
