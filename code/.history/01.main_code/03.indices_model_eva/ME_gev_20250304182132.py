...
for i in range(12):
    ...
    if os.path.exists(csv_name):
        ...
        data = pd.concat([data['name_station'], data['shape'], data['DT_20'], data['DT_50'], data['DT_MST']], axis=1)
    ...
    if i > 1:
        ...
        min_shape = data['shape'].min() if data['shape'].min() < min_shap else min_shape
