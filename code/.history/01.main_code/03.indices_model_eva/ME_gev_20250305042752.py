...
legend_elements = [mlines.Line2D([0], [0], marker=markers[i], color='w', markeredgecolor=edgecolors[i], label=f'ri={1}' if i==0 else f'ri={i*3}', markerfacecolor=None, markersize=) for i in range(len(markers))]
