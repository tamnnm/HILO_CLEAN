...
def plot_dom():
    ...
    for i,ax in enumerate(axes.flatten()):
        ...
        for autotext in p:
            ...
            elif pct < 30 and pct > 15:
                autotext.set_rotation(10)
            elif pct <15 and pct > 5:
                autotext.set_rotation(-7)
            
        w,l,p=ax.pie([now.count(0), now.co`:wunt(1)],# labels = ['Frequency', 'Intensity'],
            autopct='%1.1f%%',pctdistance = 0.75, colors = ['#bd004e', '#142354'], startangle=angle,
        ...
        for autotext in p:
            ...
            if pct > 50:
                ...
                autotext.set_rotation(10)
            elif pct <15 and pct > 10:
                autotext.set_rotation(-5)
