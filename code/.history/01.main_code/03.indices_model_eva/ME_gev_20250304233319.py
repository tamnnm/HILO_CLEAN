...
for j,ax in enumerate(axes.flatten()):
    for i in range(12):
        ...
        if i_ri%3 == 0: # or i_ri == 1:#(i_ri == 1 and j%2 != 0):
            ...
            max_value = min_20 if '20' in indice_list[int(j//2)] else min_50
            # Remember to check MST as a single value only
            sc = ax.scatter(valid_data['shape'], valid_data[indice_list[int(j//2)]] - min_value, c=valid_data['scale'], marker=markers[order], cmap='Spectral', s=100, edgecolors=edgecolors[order])
