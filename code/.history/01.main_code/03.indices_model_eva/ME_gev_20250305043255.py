...
legend_elements = [mlines.Line2D([0], [0], marker=markers[i], color='w', markeredgecolor='k', label=f'ri={i*3}', markerfacecolor='k', markersize=30) for i in range(len(markers))]
