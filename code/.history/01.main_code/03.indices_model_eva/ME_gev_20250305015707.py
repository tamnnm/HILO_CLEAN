...
for j,ax in enumerate(axes.flatten()):
    for i in range(12):
        ...
        # else:
            ...
            ri = 1/(i_ri)
            org_data['DT_20'] = DT(20, org_data['loc'], org_data['shape'], org_data['scale'], ri=ri)
            org_data['DT_50'] = DT(50, org_data['loc'], org_data['shape'], org_data['scale'], ri=ri)
            org_data['DT_MST'] = x_Tr(1, org_data['loc'], org_data['shape'], org_data['scale'], ri=ri) - org_data['MST']
...
# DTi_20 = np.linspace(0.01,50, 1000)
# DTi_50 = np.linspace(0.01,50, 1000)
...
# print(SIG_20)
# for j, ax in enumerate(axes.flatten()):
#     if indice_list[int(j/2)] == 'DT_20':
#         CS = ax.contour(K_20,DTi_20,SIG_20,level = 100, colors='black',linestyles='dashed')
#         ax.clabel(CS, inline=1, fontsize=10)
#     if indice_list[int(j/2)] == 'DT_50':
#         CS = ax.contour(K_50,DTi_50,SIG_50,level = 100,colors='black',linestyles='dashed')
#         ax.clabel(CS, inline=1, fontsize=10)
#     # if j%2 != 0:
#     #     ax.set_xscale('log')
...
cbar = fig.colorbar(sc, ax=axes, orientation='horizontal', pad =0.06)
