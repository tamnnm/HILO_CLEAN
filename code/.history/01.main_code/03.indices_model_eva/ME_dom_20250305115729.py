...
def s_n_i(option):
    ...
    for no_station in no_R_station:
        pcp_ind = pcp_subset.sel(no_station = no_station).values[1::][i::4]
        no_wet_ind = no_wet_subset.sel(no_station = no_station).values[1::][i::4]
        sdii_ind = sdii_subset.sel(no_station = no_station).values[1::][i::4]
