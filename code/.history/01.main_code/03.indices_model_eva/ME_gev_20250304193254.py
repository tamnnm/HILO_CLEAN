...
def doubling(resample_mode, gev_fit=False, doubling: Optional[Literal['linear', 'log', 'both']] = 'linear'):
    ...
    ax.annotate("",xy=(0.75, 0.28), xycoords = 'axes fraction', xytext = (0.45, 0.4), textcoords = 'axes fraction', arrowprops = {'arrowstyle':'simple, head_width', 'facecolor': 'black','linewidth': 6, 'connectionstyle':"arc3,rad=-0.2"})
