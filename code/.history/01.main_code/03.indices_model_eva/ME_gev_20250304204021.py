...
for i in range(12):
    ...
    # else:
        ...
        ri = 1/(i_ri)
        org_data['DT_20'] = DT(20, data['loc'], data['scale'], data['shape'], ri=ri)
        org_data['DT_50'] = DT(50, data['loc'], data['scale'], data['shape'], ri=ri)
        org_data['DT_MST'] = x_Tr(1, data['loc'], data['scale'], data['shape'], ri=ri) - data['MST']
