...
def delta_gev(ind = 'Tx'):
    ...
    min_20, max_20, min_50, max_50, min_shape, max_shape = 200, 0, 200, 0, 200, 0
    for i in range(12):
        i_ri = i+1
        # Run fit check
...
def cluster_plot(ind='Tx', resample_mode = 3):
    ...
    gs = fig.add_gridspec(1, 2, width_ratios=[5,1], wspace = -0.5)
