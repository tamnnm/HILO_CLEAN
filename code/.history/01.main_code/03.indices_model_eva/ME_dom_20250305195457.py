...
def process_station(no_station, pcp_subset, no_wet_subset, sdii_subset):
...
def s_n_i(option):
    ...
    with multiprocessing.Pool() as pool:
        for no_station in no_R_station:
            dom_seas_all.append(pool.apply(process_station, args = (no_station, pcp_subset, no_wet_subset, sdii_subset)))
...
def plot_dom():
    ...
    for i,ax in enumerate(axes.flatten()):
        ...
        now = dom_seas_now[:,0,0][i::4].tolist()
        angle = 60
        text_props = {'color': 'w','rotation' : 30, 'fontsize': 35}
        ...
        if i!= 1: # JJA
            ax.pie([all.count(0), all.count(1)],# labels = ['Frequency', 'Intensity'],
                ...
                radius=1.3,pctdistance = 0.85, textprops = {'color': 'w', 'rotation' : 30, 'fontsize': 35},
                wedgeprops=dict(width=0.4, edgecolor = 'w', linewidth = 10))
            ax.pie([now.count(0), now.count(1)],# labels = ['Frequency', 'Intensity'],
                autopct='%1.1f%%',pctdistance = 0.6, colors = ['#bd004e', '#142354'], startangle=angle,
                radius=0.6,textprops = {'color': 'w','rotation' : 30, 'fontsize': 35},
            ...
            ax.pie([now.count(0), now.count(1)],# labels = ['Frequency', 'Intensity'],
                ...
                #autopct='%1.1f%%',pctdistance = 0.6, textprops = {'color': 'w','rotation' : 30, 'fontsize': 35},
                wedgeprops=dict(width=0.35,edgecolor = 'w', linewidth = 10))
        ax.pie([base.count(0), base.count(1)],# labels = ['Frequency', 'Intensity'],
               colors = ['#bd004e', '#142354'], startangle=angle,
               radius=0.9,autopct='%1.1f%%', pctdistance = 0.81,textprops = {'color': 'w','rotation' : 30, 'fontsize': 35},
