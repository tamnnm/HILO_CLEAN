#### CONVERSION FROM NETCDF TO IMMEDIATE FILE FOR WRF ###
...
# Paths and Files
tsoil = open_nc_file('tsoil', sel_year=year)
soilw = open_nc_file('soilw', sel_year=year)

# surface
t2m = open_nc_file('air.2m', sel_year=year)
skt = open_nc_file('skt', sel_year=year)
u10 = open_nc_file('u10', sel_year=year)
v10 = open_nc_file('v10', sel_year=year)
psfc = open_nc_file('pres.sfc', sel_year=year)
mslp = open_nc_file('prmsl', sel_year=year)
rhum2m = open_nc_file('rhum.2m', sel_year=year)

# level data
uwnd = open_nc_file('uwnd', sel_year=year)
vwnd = open_nc_file('vwnd', sel_year=year)
air = open_nc_file('air', sel_year=year)
rhum = open_nc_file('rhum', sel_year=year)
shum = open_nc_file('shum', sel_year=year)
hgt = open_nc_file('hgt', sel_year=year)
...
# ? Extraction values of dimension
